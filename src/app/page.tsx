              ...
              <TableBody>
                {timeSlots.map((slot) => (
                  <TableRow key={slot.time}>
                    ...
                    <TableCell>
                      {slot.people.length > 0 ? (
                        <div>
                          ...
                          <div className="text-sm text-gray-500">{slot.people[0].phone}</div>
                          {slot.people.length > 1 && !expandedSlots.has(slot.time) && (
                            <div className="text-sm text-gray-500 mt-1">
                              +{slot.people.length - 1} more
                            </div>
                          )}
                          {expandedSlots.has(slot.time) && slot.people.slice(1).map((person, index) => (
                    ...
                    <TableCell>
                      {slot.people.length === 0 && (
                        <Badge variant="outline" className="bg-red-100 text-red-800">Empty</Badge>
                      )}
                      {slot.people.length === 1 && (
                        <Badge variant="outline" className="bg-yellow-100 text-yellow-800">Partially Filled</Badge>
                      )}
